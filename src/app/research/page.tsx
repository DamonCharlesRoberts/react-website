...
export default function Page() {
  ...
  const getOpacity = (index: number) => {
    ...
    const opacity = Math.min(1, Math.max(0.2, (scrollY - index * 50) / 100));
    return opacity;
  };
  ...
  return (
    <section>
      ...
      <p>
        Roberts, Damon C. and Jennifer Wolak. 2022.{" "}
        <q> Do Voters Care about the Age of their Elected Representatives? </q>
        <i>Political Behavior</i>. DOI:{" "}
      ...
      >
        ...
        <i>American Politics Research</i>. DOI:{" "}
      ...
      >
        Roberts, Damon C. and Stephen M. Utych. 2022.{" "}
        <q>
          A Delicate Hand, or Two Fisted Aggression? How Gendered Language
          Influences Candidate Perceptions.
        </q>{" "}
        <i>American Politics Research</i>. DOI:{" "}
      ...
      >
        Roberts, Damon C. and Stephen M. Utych. 2021.{" "}
        <q>
          Polarized social distancing: Residents of Republican‐majority counties
          spend more time away from home during the COVID‐19 crisis.
        </q>
      ...
      >
        Roberts, Damon C. and Stephen M. Utych. 2020.{" "}
        <q>
          Linking Gender, Language, and Partisanship: Developing a Database of
          Masculine and Feminine Words.
        </q>{" "}
        <i>Political Research Quarterly</i>. DOI:
      ...
      <h3
        ...
        style={{ opacity: getOpacity(4), transition: "opacity 0.2s eas-out" }}
      >
        Books
      </h3>
      <p
      ...
      >
        Roberts, Damon C. 2024.{" "}
        <q>
          The shape and color of politics: How Citizens Process Political
      ...
      >
        Roberts, Damon C.{" "}
        <q>
          Economic concerns appear to be weak predictors of white political
          identity.
        </q>{" "}
        <i>Working Paper</i>
      </p>
      ...
      >
        Roberts, Damon C.{" "}
        <q>
          Giving the leaves back to the forest: A primer on the use of random
          forest models as chained equations for imputing missing data.
        </q>{" "}
        <i>Working Paper</i>
      </p>
      <div
      ...
      >
        Roberts, Damon C. and Jennifer Wolak. 2022.{" "}
        <q>Will Biden&apos;s age keep him from being re-elected?</q>{" "}
        <i>Washington Post</i>.
      </p>
      ...
      <br></br>
      <p
        style={{ opacity: getOpacity(10), transition: "opacity 0.2s ease-out" }}
      >
        ...
        <a href="https://www.npr.org/2023/07/31/1190675707/mcconnell-feinstein-medical-episodes-maximum-age-limits">
          After McConnell&apos;s and Feinstein&apos;s episodes, should age
          limits be on the table?
        </a>
      </p>
      <br></br>
      <p
        style={{ opacity: getOpacity(11), transition: "opacity 0.2s ease-out" }}
      >
        <i>New York Times</i>{" "}
      ...
      <br></br>
      <p
        style={{ opacity: getOpacity(12), transition: "opacity 0.2s ease-out" }}
      >
      ...
      <br></br>
      <p
        style={{ opacity: getOpacity(13), transition: "opacity 0.2s ease-out" }}
      >
        <i>University of Colorado Boulder press</i> On: Joe Biden&apos;s
        re-election announcement and his age. May 2023.
      </p>
    </section>
  );
}
