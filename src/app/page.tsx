  ...
  return (
    <section>
      ...
      <p className="mb-4 text-center">
        ...
        journals such as Political Behavior, Political Research Quarterly,
        Social Science Quarterly, and American Politics Research. My
        public-facing work has also been featured in The Washington Post’s
        Monkey Cage Blog (now Good Authority).
      </p>
